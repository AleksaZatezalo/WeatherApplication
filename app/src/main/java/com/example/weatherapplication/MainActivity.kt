...
class MainActivity : AppCompatActivity() {
    ...
    val API: String = "b780a20dfdb8a9a8c25fea50ca8eeeb0"
    ...
    inner class weatherTask(): AsyncTask<String, Void, String>()
    {
        ...
        override fun doInBackground(vararg p0: String?): String? {
            var response:String?
            try{
                response = URL("https://api.openweathermap.org/data/2.5/weather?q=$CITY&units=metroc&appid=$API")
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                val updatedAtText = "Updated at: " + SimpleDateFormat("dd/MM/yyy hh:mm a",
